          ...
          <ProjectSectionContent>
            <ProjectTextRow width="m">
              ...
              <ProjectSectionText>
                <ul>
                  <li>
                    I use <Link href="https://www.python.org/">Python</Link> as my backend
                    programming language, with the Django Rest Framework theme and
                  ...
                  <li>
                    ...
                    Python library of choice. The component-centric mental model is the
                    first thing that truly made sense to me as a Fullstack Developer.
                  </li>
                  <li>
                    For J2EE Technologies I use JDBC, Servlets and JSP. It has a bit of a
                    learning curve but you can do some really powerful stuff with it.
                  </li>
                  <li>
                    For Cloud Computing I've used AWS EC2, S3, RDS (MySQL), SQS solutions
                  </li>
                  <li>
                    For JDatabases I use Oracle (9i,10g, 11g), My SQL, Apache Cassandra,
                    MongoDB
                  </li>
                  <li>For Issue Tracking I use Bugzilla, JIRA and Crucible. .</li>
                </ul>
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
