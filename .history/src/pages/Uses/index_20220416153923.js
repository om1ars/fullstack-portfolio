            ...
            <ProjectTextRow width="m">
              ...
              <ProjectSectionText>
                <ul>
                  <li>
                    I use{' '}
                    <Link href="https://www.python.org/">Django</Link>{' '}
                    as my backend framework, with the Django Rest Framework theme and PostgreSql as
                  ...
                  <li>
                    <Link href="https://djangoproject.com/">Python</Link> is my back end
